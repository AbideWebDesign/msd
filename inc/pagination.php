...
if ( ! function_exists( 'msd_pagination' ) ) {
	/**
	 ...
	 */
	function msd_pagination( $args = array(), $class = 'pagination' ) {
		...
		$args = wp_parse_args(
			...
			array(
				'mid_size'           => 2,
				'prev_next'          => true,
				'prev_text'          => __( '&laquo;', 'msd' ),
				'next_text'          => __( '&raquo;', 'msd' ),
				'type'               => 'array',
				'current'            => max( 1, get_query_var( 'paged' ) ),
				'screen_reader_text' => __( 'Posts navigation', 'msd' ),
			)
		);
		...
		<nav class="d-flex justify-content-center bg-light w-100 py-1 text-center" aria-labelledby="posts-nav-label">
