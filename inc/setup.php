...
function admin_bar_style_override() {
	...
	if ( is_user_logged_in() ) {
		...
		<style>
			...
			.toplevel_page_wpseo_workouts, .acf-to-rest-api-donation-notice, #directory-categorydiv, .ac-message, #ac-pro-version, #direct-feedback, .installer-plugin-update-tr, .plugins .dashicons, .shortpixel-notice, #emr-news, .wrap.emr_upload_form .option-flex-wrapper, .emr_upload_form #message, .user-syntax-highlighting-wrap {
				display: none;
			}
